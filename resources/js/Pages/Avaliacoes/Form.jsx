...
const AvaliacaoForm = ({ avaliacao = {}, action }) => {
	const { data, setData, post, put, errors } = useForm({
		//nome: avaliacao.nome || "",
		//data: avaliacao.data || "",
		valor_total: avaliacao.valor_total || 0,
		itens: avaliacao.itensAvaliacao || [],
	});
	...
	const handleItemChange = (index, field, value) => {
        ...
        if (field === 'produto_id') {
            ...
            if (hasDuplicates) {
                setFormError('Não é permitido incluir itens duplicados na avaliacao.');
            } else {
                setFormError('');
            }
        }
	...
	const handleSubmit = (e) => {
        ...
        setFormError('');
        action === 'create' ? post('/avaliacoes') : put(`/avaliacoes/${avaliacao.id}`);
    };
